package com.example.api_monitoring_starter.Application.Service;
...
public class ApplicationMonitoringService {
    ...
    public ApplicationInfoDTO getApplicationInfo() {
        ...
        HealthEndpoint healthEndpoint =
                healthEndpointProvider.getIfAvailable();
        ...
        try (Connection connection =
            ...
            dto.setDatabaseProduct(
                    metaData.getDatabaseProductName()
            );

            dto.setDatabaseStatus(
                    "CONNECTED"
            );
        ...
        Map<String, String> environmentData =
                new LinkedHashMap<>();
...
// =========================================================
    ...
    private double getHttpRequestCount() {
        ...
        for (Meter meter : meterRegistry.getMeters()) {
            ...
            if (!"http.server.requests".equals(
                    meter.getId().getName())) {
                continue;
            }
